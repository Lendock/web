...
<html lang="en">
    ...
    <body class="bg-filter push">
            ...
            <div class="row margin-top-65">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4" id="request-detail">
                    <div class="row margin-top-15">
                        ...
                        <div class="col-xs-12">
                            <img style="width: inherit"  class="sent-request-image" src="img/bmw/2015-BMW-M3-sedan-317-876x535.jpg">
                        </div>
                    </div>
        ...
        <script>
            ...
            <c:if test="${param.request} != null">
                $.getJSON("/GetRequest?rid=" + ${param.request}, function (data) {
                    $(".chat").html("");
                    $("#borrower-photo").attr("src", "/data/users/" + data.requester.photo);
                    $("#borrower-name").html(data.requester.fName + " " + data.requester.lName);
                    $("#borrower-name").attr('href', 'profile-public?uid=' + data.requester.id);
                ...
                $.getJSON("/GetMessages?mode=all&rid=" + ${param.request}, function (data) {
