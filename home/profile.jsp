            ...
            <div class="row margin-top-65">
                <div class="col-sm-3 col-md-2">
                    <ul class="nav nav-pills nav-stacked dashboard-tabs" id="example-vert-tabs">
                        <li class="tabs-title active"><a href="/home/profile.jsp"><img class="tabs-icons" src="../img/profile-white.png"><br>Profile</a>
                        </li>
            ...
            $(function () {
                $.getJSON("/GetReviews", function (data) {
                    $.each(data, function (key, val) {
                        $(".listing-review").append("<div class='row'><div class='col-sm-2 col-md-1'><a href='/profile-public.jsp?uid=" + val.reviewer.id + "'><img class='media-photo round-photo center-block' style='height: 50px; width:50px;' src='/data/users/" + val.reviewer.photo + "'></a></div><div class='lender-name'><a href='/profile-public.jsp?uid=" + val.reviewer.id + "'>" + val.reviewer.fName + " " + val.reviewer.lName + "</a></div>"+ loop(val.rating) +"<div class='review-text'>" + val.description + "</div></div>");
                    });
                });
