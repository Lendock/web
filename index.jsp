            ...
            <div class="fullWidth">
                <div class="cover-photo">
                    <div class="dark-cover">
                        <h1 class="cover-text center-block">Uyğun nəqliyyat vasitəsi tap</h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container">
                ...
                <div class="row ">
                    <div class="car-type">                                                      
                        ...
                        <div class="form-group col-xs-4 col-md-1 margin-top-20" style="z-index:2">
                            <input id="type2" type="radio" class="radio-button" value="9" name="car-type">
            ...
            <div class="row" style="text-align: center; font-weight: bold;">
                <div class="col-xs-12 margin-bottom-20 margin-top-15">
                    <h3>Çevik axtarış düymələrindən istifadə et</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <a href="/SearchResult?date-min=&date-max=&price-min=0&price-max=1000&for-wedding=true">
                        <div class="quick-card-wedding margin-bottom-20">
                            <div class="dark-overlay">
                                <span class="card-text">Toy Maşınları</span>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <a href="/SearchResult?date-min=&date-max=&price-min=0&price-max=1000&car-type=9">
                        <div class="quick-card-bus margin-bottom-20">
                            <div class="dark-overlay">
                                <span class="card-text">Avtobuslar</span>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="container">
                ...
                <div class="row margin-top-15">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="item-box">
                            <a href="/GetListing?id=10">
                                <div class="image-box" style="background-image: url(/data/cars/10-CC-112/5)">
                                    <div class="item-price">
                                        <span class="azn">M</span>50/günlük
                                    </div>
                                </div>
                            </a>
                            <div class="title-box">
                            ...
                            <div class="item-specs">
                                <div class="specs-icon">
                                    ...
                                    <span class="specs-detail">5 seats</span>
                                </div>
                                <div class="specs-icon">
                                ...
                                <div class="specs-icon">
                                    ...
                                    <span class="specs-detail">Benzene</span>
                                </div>
                                <div class="specs-icon">
                                    <img src="img/driving2.png">
                                    <span class="specs-detail">Auto</span>
                                </div>
                            </div>
                        </div>
                    </div>               
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="item-box">
                            <a href="/GetListing?id=12">
                                <div class="image-box" style="background-image: url(/data/cars/10-CC-114/4)">
                                    <div class="item-price">
                                        <span class="azn">M</span>50/günlük
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="item-box">
                            <a href="/GetListing?id=13">
                                <div class="image-box" style="background-image: url(/data/cars/10-CC-115/6)">
                                    <div class="item-price">
                                        <span class="azn">M</span>160/günlük
                                    </div>
                                </div>
                            </a>
                            <div class="title-box">
                            ...
                            <div class="item-specs">
                                <div class="specs-icon">
                                    <img src="img/silhouette42.png">
                                    <span class="specs-detail">7 seats</span>
                                </div>
                                <div class="specs-icon">
                                    <img src="img/stacked9.png">
                                    <span class="specs-detail">Wagon</span>
                                </div>
                                <div class="specs-icon">
                                    <img src="img/fuel19.png">
                                    <span class="specs-detail">Benzene</span>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="item-box">
                            <a href="/GetListing?id=14">
                                <div class="image-box" style="background-image: url(/data/cars/10-CC-116/3)">
                                    <div class="item-price">
                                        <span class="azn">M</span>100/günlük
                                    </div>
                                </div>
                            </a>
                            <div class="title-box">
                            ...
                            <div class="item-specs">
                                <div class="specs-icon">
                                    <img src="img/silhouette42.png">
                                    <span class="specs-detail">2 seats</span>
                                </div>
                                <div class="specs-icon">
                                    <img src="img/stacked9.png">
                                    <span class="specs-detail">Convertible</span>
                                </div>
                                <div class="specs-icon">
                                    <img src="img/fuel19.png">
                                    <span class="specs-detail">Benzene</span>
